...
public class XQueryExecutor {
    ...
    if (query == null) throw new RuntimeException("No XQuery provided for entity: " + entityClass.getSimpleName());
...
public Optional<Object> findById(XResourceMetadata metadata,Map<String,XQuery> xQueries,Map<String, Object> context,Object id){
...
public <T> List<T> executeXQueries(Class<T> entityClass, Map<String, XQuery> xQueries, Map<String, Object> context) {
    if (xQueries == null || xQueries.isEmpty()) {
        throw new RuntimeException("No XQueries provided for entity: " + entityClass.getSimpleName());
    }
