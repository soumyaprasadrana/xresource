...
import org.xresource.core.cron.XJobRegistry;
import org.xresource.core.cron.XJobRunner;
...
import org.xresource.core.util.XResourceRepositoryScanner;
...
public class XResourceAutoConfig {
    ...
    public XRoleBasedAccessEvaluator xRoleBasedAccessEvaluator() {
        return new XRoleBasedAccessEvaluator((type, level, resource, field, roles) -> {
            return level;
        });
    }
